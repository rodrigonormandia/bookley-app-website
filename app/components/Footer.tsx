            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                >
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold">Bookley</span>
                        </div>
                        <p className="text-sm text-gray-400 leading-relaxed mb-6">
                            Plataforma completa para profissionais de saúde mental gerenciarem sua prática clínica.
                        </p>
                        {/* Social Icons */}
                        <div className="flex gap-3">
                            {[
                                ...
                                <a
                                    ...
                                    className="w-9 h-9 bg-gray-700 hover:bg-[var(--color-primary)] rounded-lg flex items-center justify-center transition-colors"
                                >
                                    {social.svg}
                                </a>
                            ))}
                ...
                <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-sm text-gray-400">
                        © {new Date().getFullYear()} Bookley. Todos os direitos reservados.
                    </p>
                    <p className="text-sm text-gray-400">
